...
\item[\card{Ace}] The following hand must pick up four cards.  The player of the ace must say ``Sorry'', although
  ...
  \item[\card{4}]
    ...
    Everyone passes his entire hand to the next player in the direction of play (i.e. the player of the 4
    ...
    of the hand omitted to say, ``last card'' they are still responsible for the pending penalty --- it does not transfer with the hand.

    Some variants are possible:
    \begin{itemize}
      \item Only red 4s are active;  black 4s have no special meaning.
      \item You may butt-in before the hands are passed (resulting in passing them two positions)
    \end{itemize}
