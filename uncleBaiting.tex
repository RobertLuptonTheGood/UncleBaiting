...
Cousins, Sons, Daughters, and Friends;  this is an equal-opportunity game.
...
\item[\card{Ace}] The following hand must pick up four cards.  The player of the ace must say, ``Sorry'', although
  ...
  \item[\card{Jack}]
    ...
    If you fail to announce the new suit the next player may play as if you'd nominated
    the Jack's own suit --- this allows play to continue, resulting in a penalty for
    not naming a suit.
