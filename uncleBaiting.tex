...
Although the game's called Uncle Baiting, it's perfectly permissible to bait Aunts, cousins,
sons, daughters, and friends;  this is an equal-opportunity game.
...
\item[\card{Ace}]
  ...
  \item[\card{7}] The next card played must be 5 or less if the 7 is red; Jack or higher if the 7's black.
    ...
    The reason for the apparently asymmetrical ranges or permitted cards (Ace ... 5 v. Jack ... King)
    is that in fact there are four possible Jacks that can be played, so the ranges are in fact almost
